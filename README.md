...
Guías en HTML autocontenidas (sin dependencias externas de build) sobre JavaScript, pensadas para repasar los temas vistos en clase:

1. [01.guia-estudio-sintaxis-js.html](01.guia-estudio-sintaxis-js.html) — Sintaxis básica de JavaScript
...
5. [05.guia-estudio-express-arquitecturas](05.guia-estudio-express-arquitecturas.html) — Arquitecturas en APIs de Node.js (Express, cómo estructurar un proyecto REST)
